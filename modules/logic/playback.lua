...
-- function playback.run(recorder)
--     for _, v in pairs(recorder.baseUI.arrangeUI.loadedRecords) do
--         v:setCurrentFrame(playback.currentFrame)
--         playback.play(v)
--     end
--     if playback.isPlaying and not playback.isPaused then
--         playback.jumpToFrame(playback.currentFrame)
--         playback.currentFrame = playback.currentFrame + 1
--     end
--     if playback.currentFrame >= playback.getLongestRecord(recorder) then
--         playback.isPlaying = false
--         playback.isPaused = false
--     end
-- end

-- function playback.getLongestRecord(recorder)
--     local biggest = 0
--     for _, r in pairs(recorder.baseUI.arrangeUI.loadedRecords) do
--         if r.info.frames > biggest then biggest = r.info.frames end
--     end
--     return biggest
-- end
...
-- function playback.play(record)
--     record:playFrame(playback.currentFrame)
-- end

-- function playback.startPlayback()
--     seplaybacklf.isPlaying = true
--     playback.isPaused = false
-- end

-- function playback.pausePlayback()
--     playback.isPlaying = not self.isPlaying
--     playback.isPaused = not self.isPaused
-- end

-- function playback.resetPlayback()
--     playback.isPlaying = false
--     playback.isPaused = false
--     playback.jumpToFrame(1)
-- end

-- function playback.jumpToFrame(frame, record)
--     frame = math.max(math.min(frame, self:getLongestRecord()), 1)

--     local originFrame = playback.currentFrame
--     if frame < playback.currentFrame then
--         playback.currentFrame = frame
--         for _, v in pairs(self.recorder.baseUI.arrangeUI.loadedRecords) do
--             playback.getLastRecordEffects(v, originFrame)
--         end
--     elseif frame > playback.currentFrame then
--         playback.currentFrame = frame
--             for _, v in pairs(self.recorder.baseUI.arrangeUI.loadedRecords) do
--                 playback.getLastRecordEffects(v, originFrame)
--             end
