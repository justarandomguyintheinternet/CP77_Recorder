...
function clear:new(frame, record)
	local o = {} 
...
function clear:updateOffset(ofs)
...
function clear:updateCompatible()
...
function clear:draw()
	...
	ImGui.BeginChild("subject_clear_" .. self.childId, self.saveBoxSize.x, self.saveBoxSize.y, true)

    ImGui.Text("Subject | Clear")
